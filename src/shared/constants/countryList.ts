...
export const countryList: Country[] = [
    ...
    { name: "Dominican Republic", code: "DO", dial_code: "+1 849", flag: "🇩🇴" },
    ...
    { name: "Virgin Islands, British", code: "VG", dial_code: "+1 284", flag: "🇻🇬" },
    { name: "Virgin Islands, U.S.", code: "VI", dial_code: "+1 340", flag: "🇻🇮" },
